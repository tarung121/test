...
Scenario Outline: Get Fees Details Validation
     ...
     * def totalFees = licenseFees  + fillingFees
     And print totalFees	
   				   And request {"mainLicensePermitTypeId":58,"newPermitTypeIds":[],"combinedCraftId":null,"masterFileId":null,"isApplicableForTempPermit":true,"isNotQualified":false,"isChainRestaurant":false,"addBarList":[],"tempLicensePermitTypeId":383,"countyId":14,"isApplicantCurrentLicensed":false,"isExistingManufacturer":false,"selectedLicense":null,"isAssociatedTempPermit":false}
	  When method post
	  Then status 200
	 
	   And def ApplicationId = response[0].parentApplicationId
...
# ********* SAVE Application Details To Save *********************
  ...
  Examples:
   | read('/LicenseInputs/BusinessRulePermitFee.csv') |