  ...
  # ********* GET License Id *********************  
   ...
   # And match licId != []
    And match licenseId != []
        ...
        * call read('AmendmentsCommonMethods.feature@AmendmentTypeFeesValidation1') {}
        * def ExpiryMonth = getExpiryMonth()
        * def EffectiveMonth = EffMonth()
        And print ExpiryMonth
        And print EffectiveMonth
        * def noOfMonthsRemaining = ExpiryMonth - EffectiveMonth
        * def AmendmentFees = (153/36)*noOfMonthsRemaining
        #* def AmendmentFees = '#(AmendmentFees)'
          #And eval if(totalFees => 500) AmendmentFees = 192
          #And eval if(totalFees < 500) AmendmentFees = 32
          And print AmendmentFees
          And print amendmentFees
          And print noOfMonthsRemaining
          * match AmendmentFees == amendmentFees
        * configure continueOnStepFailure = true

  Examples:
   | read('/LicenseInputs/TruckingPermitFee.csv') |