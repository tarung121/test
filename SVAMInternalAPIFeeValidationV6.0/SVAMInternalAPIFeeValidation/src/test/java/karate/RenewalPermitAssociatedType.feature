...
Scenario Outline: Renewal StandAlone Permit Submission
    ...
    ## ******************** LicenseApproval Scenario End ***************************##
        ...
        * call read('PermitScenarios.feature@searchLicensesAndPermits') {}
	    * call read('PermitScenarios.feature@IntakeAssociatedPermit') {}
...
Examples:
    | read('/LicenseInputs/AssociatedPermit.csv') |
