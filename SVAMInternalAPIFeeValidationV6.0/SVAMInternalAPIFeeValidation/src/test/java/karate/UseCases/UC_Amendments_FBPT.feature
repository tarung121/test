...
@TC0001_NYC_SLA_LIC_AMD_FBPT_Redirects_For_LB_Decision	  
	...
	# ********* Login Functionality *********************
	  ...
	  * def SearchByLegalName = true
	    ...
	    * call read('AmendmentsCommonMethods.feature@AmendmentFeeValidation') {amount:128}
	  	* call read('AmendmentsCommonMethods.feature@SubmitLicenseAndValidateLicStatus') {expStatus:'Awaiting Review'}
	   * call read('AmendmentsCommonMethods.feature@ValidateLicenseApplicationStatus') {LicAppStatus:'IntakeComplete'}
	   ...
	   * call read('LicensesCommonMethods.feature@ValidateLicenseApplicationStatus') {LicAppStatus:'Under Review'}
		...
		* def reviewType = 'Send to Full Board Preview Team'
		...
		# * call read('AmendmentsCommonMethods.feature@SaveAndValidateAmendmentMemoLinkData') {}
	...
	# ********* Login Functionality *********************
	  ...
	  * def SearchByLegalName = false
	   ...
	   * call read('LicensesCommonMethods.feature@IntakeAmendment') {}
	    * def amendmentType = 'Method of Operation'
	   * call read('LicensesCommonMethods.feature@AmendmentFeeValidation') {amount:10}
 ...
 Scenario Outline: TC0004_NYC_SLA_LIC_AMD_Define_DeficienciesAndSend_Deficiency_Letter
	...
	# ********* Login Functionality *********************
	   ...
	   * call read('LicensesCommonMethods.feature@AmendmentFeeValidation') {amount:128}
	    ...
	    * call read('LicensesCommonMethods.feature@AssignApplicationsToExaminer') {expStatus:'Awaiting Review'}
	    * call read('LicensesCommonMethods.feature@ValidateLicenseApplicationStatus') {LicAppStatus:'Under Review'}
		* call read('LicensesCommonMethods.feature@getAmendmentABCOfficerDetails') {}
		* def deficienciesCount = 1
		* def reviewType = 'Define Deficiencies'
		
		* call read('LicensesCommonMethods.feature@AmendmentExaminerReviewApprovalToLB') {expStatus:'Additional Info Required'}
