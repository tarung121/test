...
@TC0001_SLA_REN_Send_Alert_for_Corp_LLC_Dissolved_License	  
Scenario Outline: TC0001_SLA_REN_Send_Alert_for_Corp_LLC_Dissolved_License
	...
	# ********* Login Functionality *********************
	   ...
	   ## ******************** UC_RenewalExaminerReview: Validate TC0001_SLA_REN_Send_Alert_for_Corp_LLC_Dissolved_License Scenario Start ***************************##
	   ...
	   * call read('LicensesCommonMethods.feature@SubmitLicenseAndValidateLicStatus') {expStatus:'Awaiting Review'}
	     ...
	     * call read('RenewalCommonMethods.feature@SaveDigestCORP_LLCData') {CorpLLCStatus:'Yes'}
	    
	    
	     * def licPerType = 'license'
	   	 
	    * call read('RenewalCommonMethods.feature@RenewalExaminerReviewCORP_LLC_Dissolved') {expStatus:'Disapproved'}
	   * def sleep = function(millis){ java.lang.Thread.sleep(millis) }
	    ...
	    * match serverResponseNotificationData[0].attachments[0].documentDesc contains 'Disapproval Letter'
	      ## ******************** UC_RenewalExaminerReview: Validate TC0001_SLA_REN_Send_Alert_for_Corp_LLC_Dissolved_License  Scenario End ***************************##   
 ...
 @TC0001_SLA_REN_Send_Alert_for_Corp_LLC_Dissolved_Permit 
 Scenario Outline: TC0001_SLA_REN_Send_Alert_for_Corp_LLC_Dissolved_Permit
	...
	# ********* Login Functionality *********************
		...
		* def totalFees = licenseFees+fillingFees+licAncillaryFees
	      * def splittedCityName = CityName.replaceAll(" ","")
	   ## ******************** UC_RenewalExaminerReviewApp: Validate TC0001_SLA_REN_Send_Alert_for_Corp_LLC_Dissolved_Permit Scenario Start ***************************##
		...
		* def currentDate = fundDueDateFunc1(0)  
		  * def expiryDate = fundDueDateFunc1(14) 
		* call read('RenewalCommonMethods.feature@PermitLBDecisions') {}
		* call read('LicensesCommonMethods.feature@ValidateLicenseApplicationStatus') {LicAppStatus:'Approved'}
...
## ******************** UC_RenewalExaminerReviewApp: Validate TC0001_SLA_REN_Send_Alert_for_Corp_LLC_Dissolved_Permit Scenario End ***************************##   
...
@TC0001a_SLA_REN_Send_Alert_for_Corp_LLC_Dissolved_NO_License	  
Scenario Outline: TC0001a_SLA_REN_Send_Alert_for_Corp_LLC_Dissolved_NO_License
	...
	# ********* Login Functionality *********************
		...
		* def totalFees = licenseFees+fillingFees+licAncillaryFees
	      * def splittedCityName = CityName.replaceAll(" ","")
	   ## ******************** UC_RenewalExaminerReview: Validate TC0001a_SLA_REN_Send_Alert_for_Corp_LLC_Dissolved_NO_License Scenario Start ***************************##
	   	* call read('LicensesCommonMethods.feature@IntakeLicensewithoutAssociatedLic') {}
        * def CountyName = "New York"
        * call read('LicensesCommonMethods.feature@FillAndSaveApplicantInformationPage') {county:'#(CountyName)'}
        * call read('LicensesCommonMethods.feature@FillAndSavePrincipalPage') {}
	   ...
	   * def sleep = function(millis){ java.lang.Thread.sleep(millis) }
	    ...
	    * match serverResponseNotificationData[0].attachments[0].documentDesc contains 'Disapproval Letter'
	      ## ******************** UC_RenewalExaminerReview: Validate TC0001a_SLA_REN_Send_Alert_for_Corp_LLC_Dissolved_NO_License  Scenario End ***************************##   
 ...
 @TC0001a_SLA_REN_Send_Alert_for_Corp_LLC_Dissolved_No_Permit 
 Scenario Outline: TC0001a_SLA_REN_Send_Alert_for_Corp_LLC_Dissolved_No_Permit
	...
	# ********* Login Functionality *********************
		...
		* def totalFees = licenseFees+fillingFees+licAncillaryFees
	      * def splittedCityName = CityName.replaceAll(" ","")
	   ## ******************** UC_RenewalExaminerReviewApp: Validate TC0001a_SLA_REN_Send_Alert_for_Corp_LLC_Dissolved_No_Permit Scenario Start ***************************##
	   	* call read('PermitsCommonMethods.feature@IntakeStandalonePermitwithoutLic') {}
...
## ******************** UC_RenewalExaminerReviewApp: Validate TC0001a_SLA_REN_Send_Alert_for_Corp_LLC_Dissolved_No_Permit Scenario End ***************************##   
