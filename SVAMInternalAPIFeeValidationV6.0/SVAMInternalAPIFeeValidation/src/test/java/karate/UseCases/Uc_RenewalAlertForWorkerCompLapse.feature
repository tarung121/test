...
Background:
	...
	* def getDate =
		  ...
		  """
@TC0001_SLA_REN_Send_Alert_for_Workers_Comp_Lapse	  
Scenario Outline: TC0001_SLA_REN_Send_Alert_for_Workers_Comp_Lapse
	...
	# ********* Login Functionality *********************
	   ...
	   ## ******************** UC_RenewalExaminerReview: Validate TC0001_SLA_REN_Send_Alert_for_Workers_Comp_Lapse Scenario Start ***************************##
	   ...
	   * call read('LicensesCommonMethods.feature@SubmitLicenseAndValidateLicStatus') {expStatus:'Awaiting Review'}
	   	 ...
	   	 * call read('LicensesCommonMethods.feature@searchReferToEnforcementApplicationByLegalName') {} 
	   	
	   	* call read('LicensesCommonMethods.feature@CreateCaseID') {expStatus:'Awaiting Review'}
	   ...
	   * call read('LicensesCommonMethods.feature@GetCaseDetailsFromInFromLicensingQueue') {expapplicationStatus:'Awaiting Review'}	   
	   ...
	   ## ******************** UC_RenewalExaminerReview: Validate TC0001_SLA_REN_Send_Alert_for_Workers_Comp_Lapse  Scenario End ***************************##   
