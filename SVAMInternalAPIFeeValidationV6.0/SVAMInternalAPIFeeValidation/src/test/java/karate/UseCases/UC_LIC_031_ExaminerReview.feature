...
@TC0001_NYC_SLA_LIC_Examiner_sends_Application_For_LB_Review	  
Scenario Outline: TC0001_NYC_SLA_LIC_Examiner_sends_Application_For_LB_Review
	...
	# ********* Login Functionality *********************
	   ...
	   ## ******************** UC_LIC_ExamnerReviewToLB: Validate TC0001_NYC_SLA_LIC_Examiner_sends_Application_For_LB_Review Scenario Start ***************************##
		...
		* call read('LicensesCommonMethods.feature@ValidateLicenseApplicationStatus') {LicAppStatus:'Under Review'}	   
	     ...
	     ## ******************** UC_LIC_ExamnerReviewToLB: Validate TC0001_NYC_SLA_LIC_Examiner_sends_Application_For_LB_Review Scenario End ***************************##   
...
@TC0003_NYC_SLA_LIC_Examiner_Sends_Application_For_FBPT_Review	  
Scenario Outline: TC0003_NYC_SLA_LIC_Examiner_Sends_Application_For_FBPT_Review
	...
	# ********* Login Functionality *********************
	    ...
	    * def amountPaid = totalFees+''
	      * def splittedCityName = CityName.replaceAll(" ","")
	   ## ******************** UC_LIC_031: Validate TC0003_NYC_SLA_LIC_Examiner_Sends_Application_For_FBPT_Review Scenario Start ***************************##
	    ...
	    * call read('LicensesCommonMethods.feature@AssignFBPTLicToLB') {}
	    ...
	    #* call read('LicensesCommonMethods.feature@checkApplicationStatus') {expStatus:'Awaiting Review'}
	     ...
	     ## ******************** UC_LIC_031: Validate TC0003_NYC_SLA_LIC_Examiner_Sends_Application_For_FBPT_Review Scenario End ***************************##   
...
@TC0005_NYC_SLA_LIC_Add_One_Deficiencies
Scenario Outline: TC0005_NYC_SLA_LIC_Add_One_Deficiencies
	...
	# ********* Login Functionality *********************
		...
		* def totalFees = licenseFees+fillingFees
	      * def splittedCityName = CityName.replaceAll(" ","")
	   ## ******************** UC_LIC_031: Validate TC0005_NYC_SLA_LIC_Add_One_Deficiencies Scenario Start ***************************##
	    ...
	    * call read('LicensesCommonMethods.feature@ValidateLicenseApplicationStatus') {LicAppStatus:'Under Review'}
		* call read('LicensesCommonMethods.feature@ExaminerReviewApprovalWithOneDefineDeficiencies') {expStatus:'Additional Info Required'}
	   * call read('LicensesCommonMethods.feature@ValidateLicenseApplicationStatus') {LicAppStatus:'Under Review'}
	    * call read('LicensesCommonMethods.feature@checkApplicationStatus') {expStatus:'Additional Info Required'}
		
	    
	     ## ******************** UC_LIC_031: Validate TC0005_NYC_SLA_LIC_Add_One_Deficiencies Scenario End ***************************##   
...
@TC0005_NYC_SLA_LIC_Add_All_Multiple_Deficiencies
Scenario Outline: TC0005_NYC_SLA_LIC_Add_All_Multiple_Deficiencies
	...
	# ********* Login Functionality *********************
		...
		* def totalFees = licenseFees+fillingFees
	      * def splittedCityName = CityName.replaceAll(" ","")
	   ## ******************** UC_LIC_031: Validate TC0005_NYC_SLA_LIC_Add_All_Multiple_Deficiencies Scenario Start ***************************##
	   ...
	   * call read('LicensesCommonMethods.feature@ValidateLicenseApplicationStatus') {LicAppStatus:'Under Review'}
	    * call read('LicensesCommonMethods.feature@checkApplicationStatus') {expStatus:'Additional Info Required'}
	     ...
	     ## ******************** UC_LIC_031: Validate TC0005_NYC_SLA_LIC_Add_All_Multiple_Deficiencies Scenario End ***************************##   
