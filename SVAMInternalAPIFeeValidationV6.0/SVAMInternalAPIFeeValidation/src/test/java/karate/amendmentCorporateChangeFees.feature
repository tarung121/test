Feature: amendment Corporate Changes fee validation
...
Scenario Outline: Get Fees Details Validation
        ...
        * call read('AmendmentsCommonMethods.feature@AmendmentCorporateChangesTypeSelectApplicationType') {}
        ...
        * call read('AmendmentsCommonMethods.feature@CorporateChangesTab') {}
