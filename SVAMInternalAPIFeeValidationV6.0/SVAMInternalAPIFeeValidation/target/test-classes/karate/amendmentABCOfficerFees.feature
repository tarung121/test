Feature: amendment ABC Officer fee validation
...
Scenario Outline: Get Fees Details Validation
        ...
        * call read('AmendmentsCommonMethods.feature@AmendmentABCOfficerTypeSelectApplicationType') {}
        * def autoFirstName = 'Automation' + getDate()
	    * def legalName = autoFirstName+ ' '+'Amendment'
        * call read('AmendmentsCommonMethods.feature@ABCOfficerTab') {}
