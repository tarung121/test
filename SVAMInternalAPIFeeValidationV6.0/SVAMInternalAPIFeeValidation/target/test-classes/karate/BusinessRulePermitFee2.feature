...
Scenario Outline: Get Fees Details Validation
     ...
     * def totalFees = licenseFees  + fillingFees
     And print totalFees	
   				   And request {"businessType":"","permitType":"Temporary Permit","mainLicenseId":null,"tempPermitTypeId":[{"applicationId":null,"tempLicensePermitTypeId":383}],"mainApplicationId":"","associatedLicenseList":[],"isMainTempPermitRequired":true,"newPermitTypeIds":[],"isNotQualified":false,"notQualifiedReason":""}
	  When method post
	  Then status 200
...
# ********* SAVE Application Details To Save *********************
  ...
  Examples:
   | read('/LicenseInputs/BusinessRulePermitFee2.csv') |