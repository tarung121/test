Feature: amendment Endorsement Other fee validation
...
Scenario Outline: Get Fees Details Validation
        ...
        * call read('AmendmentsCommonMethods.feature@AmendmentEndorcementOtherTypeSelectApplicationType') {}
        * def autoFirstName = 'Automation' + getDate()
	    * def legalName = autoFirstName+ ' '+'Amendment'
	    * def autoFirstName = 'Corp' + getDate()
	    * def legalName = autoFirstName+ ' '+'CorpChange'
	    * def autoFirstName = 'Automation' + getDate()
	    * def legalName = autoFirstName+ ' '+'Amendment'
        * call read('AmendmentsCommonMethods.feature@EndorsementOtherTab') {}
        * call read('AmendmentsCommonMethods.feature@AmendmentTypeFeesValidation') {}
        * configure continueOnStepFailure = true

                * configure continueOnStepFailure = true
 		        * match AmendmentFees == 64
 		        * match filingFees == 0
